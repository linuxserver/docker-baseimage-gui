pipeline {
  ...
  environment {
    ...
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-baseimage-gui'
    CONTAINER_NAME = 'baseimage-gui'
    DOCKERHUB_IMAGE = 'lsiobase/gui'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/gui'
    PR_DOCKERHUB_IMAGE = 'lspipepr/gui'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH='true'
    CI='true'
    CI_WEB='false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-baseimage-gui/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-baseimage-gui\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-baseimage-gui\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Baseimage-gui\" \
          --label \"org.opencontainers.image.description=baseimage-gui image by linuxserver.io\" \
